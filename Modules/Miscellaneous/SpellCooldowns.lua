...
-- local fontSize = C["SpellCooldowns"]["FontSize"]
-- local fontStyle = "THINOUTLINE"
-- local texture = C["SpellCooldowns"]["Texture"]
-- local size = T.Scale(C["SpellCooldowns"]["Size"])
-- local spacing = T.Scale(C["SpellCooldowns"]["Spacing"])
-- local anchor = {"CENTER", UIParent, "CENTER", 0, T.Scale(-120)}
-- local color = {1, 1, 0, 1}
...
-- local SpellCooldownFrame = CreateFrame("Frame", "RobsonUISpellCooldowns", UIParent)
...
-- tinsert(T.AllowFrameMoving, SpellCooldownFrame)
